...
// Compile-time verification (this is the important part)
static_assert(std::is_same_v<decltype(&sendChar),        SendChar*>);
static_assert(std::is_same_v<decltype(&sendStat),        SendStat*>);
static_assert(std::is_same_v<decltype(&controlledExit),  ControlledExit*>);
static_assert(std::is_same_v<decltype(&sendData),        SendData*>);
static_assert(std::is_same_v<decltype(&sendInitData),    SendInitData*>);
static_assert(std::is_same_v<decltype(&bgThreadRunning), BGThreadRunning*>);
